...
public class CadastrarUmNovoUsuarioContratoApi {
    ...
    public void valido_o_contrato_da_api_do_enpoint_cadastrar_um_novo_usuario_devera_retornar_status_code_com_os_dados_esperados_no_corpo_da_resposta(Integer int1) {
